                ...
                <div class="w-100">
                    <div class="card shadow-2-strong" style="border-radius: 2rem;  overflow:hidden">
                        <div class="card-body p-5 text-center" style="background-color: rgba(0, 0, 0, 0.5); color:white">
                            ...
                            <form method="post" action="{{ route('post.update', $post->id) }}" class="needs-validation"
                                ...
                                <div class="form-outline mb-4">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Description Here" id="floatingTextarea2" style="height: 100px"
                                ...
                                <button class="btn btn-primary btn-lg btn-block my-3" style="font-weight: bolder;"
