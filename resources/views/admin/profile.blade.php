@extends('layouts.app')
@section('title', 'Profile Admin Page')
@section('content')
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex text-black">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/adminImages/profile/' . $user->image) }}"
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex pt-1">
                                        <a href="{{ route('users.edit', $user->id) }}"
                                            class="btn btn-outline-primary me-1 flex-grow-1">Update</a>
                                        <form action="{{ route('users.destroy', $user->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                                                class="btn btn-outline-danger flex-grow-1">Delete</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
