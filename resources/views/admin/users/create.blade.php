@extends('layouts.app')
@section('title', 'Create Users Admin Panal')
@section('content')
                    ...
                    <div class="card shadow-2-strong" style="border-radius: 2rem;  overflow:hidden">
                        <div class="card-body p-5 text-center" style="background-color: rgba(0, 0, 0, 0.5); color:white">
                            ...
                            <form method="post" action="{{ route('users.store') }}" class="needs-validation" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-primary btn-lg btn-block my-3" style="font-weight: bolder;" type="submit">Create User</button>
                            </form>
                        </div>
                    </div>
                </div>
